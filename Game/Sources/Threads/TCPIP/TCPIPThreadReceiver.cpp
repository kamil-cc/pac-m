...
#include <Threads/TCPIP/TCPIPThreadReceiver.hpp>
	 ...
	 const int thd::TCPIPThreadReceiver::GAME_LISTEN_PORT = 3098; //TODO wyrzucic do pliku cpp i zrobic ustawialne
		...
		bool thd::TCPIPThreadReceiver::setBlockingMode(const int& socket, const bool blocking){ //TODO do pliku cpp
#ifdef __WIN32__
		...
		void thd::TCPIPThreadReceiver::processInput(boost::any elem){ //Todo do pliku cpp
        	try{
		...
		void thd::TCPIPThreadReceiver::operator()(){ //TODO Wyrzucic treœc do pliku .cpp
			receiverInit();
